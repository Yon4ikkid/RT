...
fn main() {
    ...
    let mut s: scene::Scene = scene::Scene { ambient_light_color: rendering::Color { r: AMB, g:AMB, b: AMB }, camera: c, objects: std::vec::Vec::new(),
                                            ...
                                            lightsource: Box::new(DirectionalLight {c: Color { r: 1.0, g: 1.0, b: 1.0 } , d: Vector { x: -1.5, y: 0.15, z: -1.0 }.unit()}) };
    let o: Object = Object { m: Material { base_color: Color {r: 1.0, g: 0.1, b: 0.1}, 
        refractive_index: 1.0, opacity: 1.0, roughness: 0.0}, s: Box::new(Sphere { c: Vector { x: -80.0, y: 90.0, z: -60.0 }, r: 65.0 }) };
    let o1: Object = Object { m: Material { base_color: Color {r: 0.1, g: 0.1, b: 1.0}, 
        refractive_index: 1.5, opacity: 1.0, roughness: 0.0}, s: Box::new(Sphere { c: Vector { x: 20.0, y: 250.0, z: -14.0 }, r: 80.0 }) };
    let o2: Object = Object { m: Material { base_color: Color {r: 1.0, g: 1.0, b: 1.0}, 
        refractive_index: 1.0, opacity: 1.0, roughness: 0.0}, s: Box::new(Plane { a: Vector { x: 20.0, y: 250.0, z: -180.0 }, n: Vector { x: 0.0, y: 0.0, z: 1.0 }.unit() }) };
