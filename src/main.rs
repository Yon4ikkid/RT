...
fn main() {
    ...
    let o: Object = Object { m: Material { base_color: Color {r: 0.9, g: 0.4, b: 0.3}, 
        refractive_index: 1.5, reflection_ratio: 0.8}, s: Box::new(Sphere { c: Vector { x: 0.0, y: 90.0, z: 0.0 }, r: 40.0 }) };
    ...
    let o2: Object = Object { m: Material { base_color: Color {r: 0.5, g: 0.76, b: 0.2}, 
