...
fn main() {
    ...
    let mut s: scene::Scene = scene::Scene { ambient_light_color: rendering::Color { r: AMB, g:AMB, b: AMB }, camera: c, objects: std::vec::Vec::new(),
                                            ...
                                            lightsource: Box::new(DirectionalLight {c: Color { r: 1.0, g: 1.0, b: 1.0 } , d: Vector { x: -0.5, y: 0.0, z: -1.0 }.unit()}) };
    let o: Object = Object { m: Material { base_color: Color {r: 0.8, g: 0.3, b: 0.3}, 
        refractive_index: 1.0, opacity: 1.0, roughness: 0.0}, s: Box::new(Sphere { c: Vector { x: -60.0, y: 90.0, z: -40.0 }, r: 65.0 }) };
    ...
    let o2: Object = Object { m: Material { base_color: Color {r: 0.6, g: 0.6, b: 0.6}, 
