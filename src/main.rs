...
use scene::{DirectionalLight, PointLight};
use tde::Sphere;

use crate::{tde::{Plane, BiconvexLens, Paraboloid}, rendering::render};
...
fn main() {
    ...
    let o2: Object = Object { m: Material { reflected_color: Color {x: 1.0, y: 1.0, z: 1.0}, transmitted_color: Color { x: 1.0, y: 1.0, z: 1.0 }, emitted_color: Color::default(), 
        refractive_index: 1.0, opacity: 1.0, roughness: 1.0}, s: &Plane { a: Vector { x: 20.0, y: 250.0, z: -180.0 }, n: Vector { x: 0.0, y: 0.0, z: 1.0 }.unit() } };
