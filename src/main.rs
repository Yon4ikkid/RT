...
fn main() {
    ...
    let o: Object = Object { m: Material { reflected_color: Color {x: 1.0, y: 0.0, z: 0.0}, transmitted_color: Color { x: 1.0, y: 1.0, z: 1.0 }, emitted_color: Color::default(), 
        refractive_index: 1.0, opacity: 1.0, roughness: 0.0}, s: Box::new(Sphere { c: Vector { x: -120.0, y: 70.0, z: -40.0 }, r: 65.0 }) };
    let o1: Object = Object { m: Material { reflected_color: Color {x: 0.1, y: 0.1, z: 1.0}, transmitted_color: Color { x: 1.0, y: 1.0, z: 1.0 }, emitted_color: Color { x: 0.8, y: 0.0, z: 0.0}, 
