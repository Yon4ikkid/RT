...
fn main() {
    ...
    const AMB: f64 = 0.5;
    let c: scene::Camera = scene::Camera::new(600, 600, 1000.0, math::Vector {x: 0.0, y: -1000.0, z: 0.0}, 0.0, 0.0, 0.0);
    let mut s: scene::Scene = scene::Scene { ambient_light_color: rendering::Color { r: AMB, g:AMB, b: AMB }, camera: c, objects: std::vec::Vec::new(),
                                            ...
                                            lightsource: Box::new(DirectionalLight {c: Color { r: 1.0, g: 1.0, b: 1.0 } , d: Vector { x: -1.0, y: 0.5, z: -1.0 }.unit()}) };
    let o: Object = Object { m: Material { base_color: Color {r: 0.8, g: 0.3, b: 0.3}, 
        refractive_index: 1.0, opacity: 0.0, roughness: 0.4}, s: Box::new(Sphere { c: Vector { x: -60.0, y: 90.0, z: -40.0 }, r: 65.0 }) };
    ...
    let o2: Object = Object { m: Material { base_color: Color {r: 0.4, g: 0.3, b: 0.3}, 
        refractive_index: 1.0, opacity: 1.0, roughness: 0.5}, s: Box::new(Plane { a: Vector { x: 20.0, y: 250.0, z: -300.0 }, n: Vector { x: 0.1, y: 0.01, z: 1.0 }.unit() }) };
